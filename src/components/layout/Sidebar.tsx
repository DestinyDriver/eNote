...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const sidebarItems = [
    {
      icon: FileText,
      label: "All Notes",
      count: sidebarCounts?.all || noteCount,
      id: "all",
    },
    {
      icon: Calendar,
      label: "Today",
      count: sidebarCounts?.today || 0,
      id: "today",
    },
    {
      icon: Star,
      label: "Starred",
      count: sidebarCounts?.starred || 0,
      id: "starred",
    },
  ];
  ...
  const toolsItems = [
    ...
    },
    {
      ...
      label: "Canvas",
      id: "canvas",
      action: () => onWorkspaceChange("canvas"),
    },
  ];
      ...
      <div className={cn("p-4", isCollapsed && "p-2")}>
        ...
        <Button
          ...
          className={cn(
            ...
            isCollapsed
              ? "w-8 h-8 p-0 rounded-md flex items-center justify-center ml-2"
              ...
              <Button
                ...
                className={cn(
                  ...
                  selectedWorkspace === item.id &&
                    "bg-gray-100 dark:bg-[#333333] text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-[#333333]",
                )}
              ...
              >
                {isCollapsed ? (
                  ...
                  <>
                    ...
                    <Badge
                      variant="secondary"
                      className="text-xs bg-gray-100 dark:bg-[#333333] text-gray-600 dark:text-gray-400"
                    >
                      {item.count}
                    </Badge>
                  </>
                    ...
                    >
                      {isCollapsed ? (
                        ...
                        <>
                          <div className="flex items-center">
                            <tag.icon
                              className={cn("w-4 h-4 mr-3", tag.color)}
                            />
                          ...
                          >
                            {sidebarCounts?.[
                              tag.id as keyof typeof sidebarCounts
                            ] || 0}
                          </Badge>
                        </>
                      )}
